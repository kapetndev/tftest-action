...
|------|-------------|---------|:--------:|
| `additional_args` | Additional argument to `tftest` | - | no |
| `format` | Output format: `text`, `json`, or `prettyjson` | - | no |
| `version` | Version of tftest to use | `latest` | no |
| `terraform_version` | Version of Terraform to use | `latest` | no |
| `working_directory` | Base path from which to start testing | - | yes |
